        ...
        <table className="w-full text-left">
            <thead>
                <tr className="text-xs text-slate-500 uppercase border-b border-slate-200">
                    ...
                    <th className="py-3">NOI (YTD)</th>
                    <th className="py-3">Open Maintenance</th>
                    <th className="py-3 text-right">Actions</th>
                </tr>
            </thead>
            <tbody>
                {propertyPerformanceData.map(prop => (
                    <tr key={prop.name} className="border-b border-slate-200 text-sm last:border-b-0">
                        ...
                        <td className="py-3 text-slate-600">${prop.noiYTD.toLocaleString(undefined, { maximumFractionDigits: 0 })}</td>
                        <td className="py-3 text-slate-600 font-medium">{prop.openMaintenance}</td>

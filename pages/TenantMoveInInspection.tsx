...
import { UploadIcon, XMarkIcon, CheckCircleIcon, PlusIcon, ChevronDownIcon, ChevronUpIcon } from '../components/Icons';
            ...
            <form onSubmit={handleSubmit}>
                <div className="bg-white rounded-lg shadow-sm border border-slate-200">
                    <div className="p-6 border-b">
                        ...
                        <p className="text-sm text-slate-500 mt-1">Click on a room to expand it. Please note the condition, add any comments, and upload photos of any damage.</p>
                    </div>

...
import { DollarIcon, DownloadIcon } from '../components/Icons';
...
const FinancialOverview: React.FC = () => {
    ...
    return (
        <DashboardLayout navItems={MANAGER_NAV} activePath="/manager/financial-overview">
            ...
            <div className="my-6 p-4 bg-white rounded-lg shadow-sm border border-slate-200 grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                <div>
                    <label className="text-xs font-medium text-slate-600">Date Range</label>
                    <select value={dateRange} onChange={e => setDateRange(e.target.value)} className="mt-1 w-full text-sm bg-white border-slate-300 rounded-md shadow-sm">
                ...
                <div>
                    ...
                    <select value={selectedOwner} onChange={e => setSelectedOwner(e.target.value)} className="mt-1 w-full text-sm bg-white border-slate-300 rounded-md shadow-sm">
                ...
                <div>
                    ...
                    <select value={selectedProperties[0] || 'all'} onChange={e => setSelectedProperties(e.target.value === 'all' ? [] : [e.target.value])} className="mt-1 w-full text-sm bg-white border-slate-300 rounded-md shadow-sm">

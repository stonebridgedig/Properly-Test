...
import { PlusIcon, SearchIcon, TrashIcon, XMarkIcon, MapPinIcon, UsersIcon, ClockIcon, ChevronUpIcon, ChevronDownIcon, EllipsisVerticalIcon, WrenchScrewdriverIcon, UploadIcon } from '../components/Icons';
import type { MaintenanceRequest, Vendor, Property, Unit, Tenant } from '../types';
                    ...
                    <div className="space-y-4">
                        ...
                        {request.status === 'New' && (
                            <div className="pt-4 border-t">
                                <h3 className="text-md font-semibold text-slate-700 mb-3">Assign Vendor</h3>
                                <div className="flex items-center space-x-3">
                                    <select value={selectedVendor} onChange={(e) => setSelectedVendor(e.target.value)} className="flex-grow text-sm bg-white border-slate-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500">
                                    ...
                                    <button onClick={handleAssignClick} disabled={!selectedVendor} className="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-md shadow-sm hover:bg-blue-700 disabled:bg-slate-400 disabled:cursor-not-allowed">

...
export const CogIcon: React.FC<{ className?: string }> = ({ className }) => (
    <IconWrapper className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M10.343 3.94c.09-.542.56-1.002 1.112-1.112l.083-.021c.241-.05.485-.098.732-.143l.25-.042c.623-.105 1.282.17 1.635.733l.05.096a8.25 8.25 0 011.233 2.193l.02.046c.158.337.494.557.87.557l.55.002c.61.002 1.141.42 1.332.992l.03.091a8.25 8.25 0 01-1.233 2.193l-.02.046c-.158.337-.494.557-.87.557l-.55.002c-.61.002-1.141.42-1.332.992l-.03.091a8.25 8.25 0 01-2.193 1.233l-.046.02c-.337.158-.557.494-.557.87l-.002.55c-.002.61-.42 1.141-.992 1.332l-.091.03a8.25 8.25 0 01-2.193-1.233l-.046-.02c-.337-.158-.557-.494-.557-.87l-.002-.55c-.002-.61.42-1.141.992-1.332l.091-.03a8.25 8.25 0 012.193-1.233l.046-.02c.337-.158.557-.494.557-.87l.002-.55c.002-.61-.42-1.141-.992-1.332l-.091-.03a8.25 8.25 0 01-2.193 1.233l-.046.02c-.337.158-.557.494-.557.87l-.002.55c.002.61.42 1.141.992 1.332l.091.03a8.25 8.25 0 01-2.193 1.233c-1.328.714-2.86.37-3.951-.81l-.034-.034a8.25 8.25 0 01-1.233-2.193l-.02-.046a1.423 1.423 0 00-.557-.87l-.55-.002a1.5 1.5 0 00-.992 1.332c-.01.242-.016.486-.021.732l-.042.25c-.105.623.17 1.282.733 1.635l.096.05a8.25 8.25 0 01-2.193 1.233c-.714 1.328-.37 2.86.81 3.951l.034.034a8.25 8.25 0 012.193-1.233l.046-.02c.337-.158.494-.557.87-.557l.55.002c.61.002 1.141-.42 1.332-.992l.03-.091a8.25 8.25 0 011.233-2.193l.02-.046c.158-.337.494-.557.87-.557l.55.002c.61.002 1.141.42 1.332.992l.03.091a8.25 8.25 0 012.193 1.233l.046.02c.337.158.557.494.557.87l.002.55c.002.61.42 1.141.992 1.332l.091.03a8.25 8.25 0 012.193-1.233c1.328-.714 2.86-.37 3.951.81l.034.034a8.25 8.25 0 011.233-2.193l.02-.046a1.423 1.423 0 00.557-.87l.55-.002c.61-.002 1.141.42 1.332.992l.03.091a8.25 8.25 0 01-1.233 2.193l-.02.046c-.158.337-.494.557-.87.557l-.55.002c-.61.002-1.141.42-1.332.992l-.03.091a8.25 8.25 0 01-2.193 1.233l-.046.02c-.337.158-.557.494-.557.87l-.002.55c.002.61-.42 1.141-.992 1.332l-.091.03a8.25 8.25 0 01-2.193-1.233c-1.328-.714-2.86-.37-3.951.81l-.034.034a8.25 8.25 0 01-2.193-1.233l-.046-.02a1.423 1.423 0 00-.87-.557l-.55.002a1.5 1.5 0 00-1.332-.992c-.242.01-.486.016-.732.021l-.25.042c-.623.105-1.282-.17-1.635-.733l-.05-.096a8.25 8.25 0 01-1.233-2.193l-.02-.046c-.158-.337-.494-.557-.87-.557l-.55.002zM15 12a3 3 0 11-6 0 3 3 0 016 0z" /></IconWrapper>
);
...
export const QuickBooksIcon: React.FC<{ className?: string }> = ({ className }) => (<svg viewBox="0 0 24 24" className={className}><path fill="#2ca01c" d="M12 2a10 10 0 100 20 10 10 0 000-20z"/><path fill="#fff" d="M12 5.5a6.5 6.5 0 100 13 6.5 6.5 0 000-13z"/><path fill="#2ca01c" d="M12 7.5a4.5 4.5 0 100 9 4.5 4.5 0 000-9z"/><path fill="#fff" d="M12 9a.5.5 0 00-.5.5v2H9.5a.5.5 0 000 1h2v2a.5.5 0 001 0v-2h2a.5.5 0 000-1h-2v-2a.5.5 0 00-.5-.5z"/></svg>);
export const XeroIcon: React.FC<{ className?: string }> = ({ className }) => (<svg viewBox="0 0 24 24" className={className}><circle cx="12" cy="12" r="10" fill="#19b1e8"/><path fill="#fff" d="M10.2 8.3l1.8 3.7 1.8-3.7h2.2l-3 5.4 3.2 5.3h-2.2l-2-4.2-2 4.2H7l3.2-5.3-3-5.4z"/></svg>);
export const BookOpenIcon: React.FC<{ className?: string }> = ({ className }) => (
    <IconWrapper className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" /></IconWrapper>
);

export const GaugeIcon: React.FC<{ className?: string }> = ({ className }) => (
  <IconWrapper className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12.75H3m18 0h-1.5m-15-4.5l-1.06-1.06c-.47-.47-1.23-.47-1.7 0s-.47 1.23 0 1.7l1.06 1.06M19.5 7.5l1.06-1.06c.47-.47.47-1.23 0-1.7s-1.23-.47-1.7 0l-1.06 1.06M19.5 16.5l1.06 1.06c.47.47.47 1.23 0 1.7s-1.23.47-1.7 0l-1.06-1.06M8.25 21v-1.5M4.5 16.5l-1.06 1.06c-.47.47-1.23.47-1.7 0s-.47 1.23 0 1.7l1.06-1.06M12 18a6 6 0 100-12 6 6 0 000 12z" /></IconWrapper>
);

export const ShieldCheckIcon: React.FC<{ className?: string }> = ({ className }) => (
  <IconWrapper className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12c0 1.268-.63 2.4-1.593 3.068a3.745 3.745 0 01-1.043 3.296 3.745 3.745 0 01-3.296 1.043A3.745 3.745 0 0112 21c-1.268 0-2.4-.63-3.068-1.593a3.746 3.746 0 01-3.296-1.043 3.745 3.745 0 01-1.043-3.296A3.745 3.745 0 013 12c0-1.268.63-2.4 1.593-3.068a3.745 3.745 0 011.043-3.296 3.745 3.745 0 013.296-1.043A3.745 3.745 0 0112 3c1.268 0 2.4.63 3.068 1.593a3.746 3.746 0 013.296 1.043 3.745 3.745 0 011.043 3.296A3.745 3.745 0 0121 12z" /></IconWrapper>
);

export const IdCardIcon: React.FC<{ className?: string }> = ({ className }) => (
  <IconWrapper className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5z" /></IconWrapper>
);
...
export const ArrowPathIcon: React.FC<{ className?: string }> = ({ className }) => (
  <IconWrapper className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.667 0l3.181-3.183m-11.667-11.667l3.181 3.183a8.25 8.25 0 0111.667 0l3.181-3.183m-11.667 11.667v4.992m-4.993 0h4.993m0 0l3.181-3.183a8.25 8.25 0 000-11.667l-3.181-3.183m0 11.667l-3.181-3.183" /></IconWrapper>
);

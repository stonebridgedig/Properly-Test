...
interface DataContextType {
  ...
  deleteCapitalProject: (projectName: string) => void;
...
export const DataProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const deleteCapitalProject = useCallback((projectName: string) => {
    setCapitalProjects(prev => prev.filter(p => p.name !== projectName));
  }, []);
  ...
  const value = useMemo(() => ({
    ...
    tenants, addTenant, updateTenant, updateTenantScreening, deleteTenants,
    rentRoll, logPayment,
    properties, addProperty, updateProperty, deleteProperties, assignOwnerToProperties,
    owners, addOwner, deleteOwners,
    capitalProjects, addCapitalProject, updateCapitalProject, deleteCapitalProject,
